...
public class Date
{
  ...
  public Date(int newMonth, int newDay, int newYear)
  {
    ...
    year = newYear;
    if (month > 12) {
  	  System.out.println("Warning: There are only 12 months in a year");
    }
    if ((month == 4 || month == 6 || month == 9 || month == 11) && day > 30) {
    	System.out.println("Warning: There are only 30 days in the given month");
    }
    if ((month == 1 || month == 3 || month == 5 || month == 7 || month == 8 || month == 10 || month == 12) && day > 31) {
    	System.out.println("Warning: There are only 31 days in the given month");
    }
    if (month == 2 && day > 29) {
    	System.out.println("Warning: February only has 29 days");
    }
   }
